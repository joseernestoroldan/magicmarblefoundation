        ...
        {stage === 1 && (
          <>
            ...
            <CardFooter className="flex justify-center">
              <Button
                onClick={handleNext}
                className="w-min px-8 bg-cyan-500 hover:bg-cyan-400 text-white rounded-full"
          ...
          <>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="border border-gray-500 rounded-full">
            ...
            <CardFooter className="flex justify-between">
              <Button
                onClick={handleBack}
                className="w-min px-8 bg-cyan-500 text-white rounded-full hover:bg-cyan-400"
              >
                Back
              </Button>
              <Button
