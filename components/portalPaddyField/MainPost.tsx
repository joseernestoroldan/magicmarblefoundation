      ...
      {_id && mainImage && (
        <Link href={`paddyfield/${_id}`}>
          <div className="bg-gray-400 h-[50vh] w-full rounded-l-[10px] relative overflow-hidden hover:brightness-75 cursor-pointer">
            ...
            />
            <div className="h-[25vh] w-[300px] rounded-tr-[5px] sm:w-[500px] bottom-0 bg-green-950 absolute bg-opacity-30 flex flex-col space-y-4 justify-start items-center pt-8 pl-4">
