  ...
  return (
    <div className="bg-fixed bg-[url('/uno.webp')] bg-no-repeat bg-cover flex flex-col justify-start items-center py-12 w-full bg-opacity-80">
      <div className="w-[90%] flex flex-col justify-start items-stretch p-12 bg-black bg-opacity-70 rounded-2xl space-y-4 max-w-5xl">
        ...
        <h2 className="text-white text-4xl text-justify font-semibold">Join Our Global Movement for Compassion</h2>

        <p className="text-white text-lg text-justify indent-6 font-normal">
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">1. Sponsor a Rescue Mission:</span>
        <p className="text-white text-lg text-justify indent-6 font-normal">
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">2. Community Relief Champions:</span>
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">3. Educate for Empowerment:</span>
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">4. Nourish Souls with Free Meals:</span>
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">5. Global Ambassadors for Change:</span>
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">6. Volunteer Globally, Act Locally:</span>
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">7. Sponsor a Rescue for Ongoing Care:</span>
        <p className="text-white text-lg text-justify indent-6 font-normal">
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">8. Donate to Multiply Impact:</span>
        <p className="text-white text-lg text-justify indent-6 font-normal">
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">9. Fundraise for Change:</span>
        ...
        <span className="text-white text-lg text-justify indent-6 font-semibold">Together, We Create Change</span>
        <p className="text-white text-lg text-justify indent-6 font-normal">
