...
const GetInvolvePage = () => {
  return (
    <div className="bg-fixed bg-[url('/uno.webp')] bg-no-repeat bg-cover flex flex-col justify-start items-center py-12 w-full bg-opacity-80">
      <div className="w-[90%] flex flex-col justify-start items-stretch p-12 bg-black bg-opacity-80 rounded-2xl space-y-4 max-w-5xl">
        <h1 className="text-gray-100 text-5xl text-center font-black">
          Be the Catalyst for Change
        </h1>

        <h2 className="text-gray-100 text-3xl text-justify font-semibold">
          Join Our Global Movement for Compassion
        </h2>

        <p className="text-gray-100 text-xl text-justify indent-6 font-normal">
        ...
        <span className="text-gray-100 text-xl text-justify indent-6 font-semibold">
        ...
        <h3 className="text-gray-100 text-4xl text-center font-black">
