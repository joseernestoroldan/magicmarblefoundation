const PrivacyPolicyPage = () => {
  return (
    <div className="flex flex-col items-center w-full max-w-5xl mx-auto pt-4 space-y-4">
      ...
      <p className="text-black font-bold italic w-full text-sm">
      ...
      <ul className="text-black w-full text-base font-medium text-justify">
      ...
      <ul className="list-disc text-black w-full text-base font-medium text-justify">
        <li className="list-disc">
      ...
      <p className="text-black w-full text-base font-medium text-justify indent-6">
        ...
        USA. If you wish to delete or deactivate your account, please email us,
      ...
      <ul className="text-black w-full text-base font-medium text-justify indent-6">
        <li className="list-disc">
