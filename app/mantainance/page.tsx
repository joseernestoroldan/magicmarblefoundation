...
const PaddyFieldMaintenancePage = () => {
  return (
    <div className="w-full bg-gradient-to-b from-white via-green-300 to-white flex flex-col items-center justify-center min-h-screen">
      <div className="bg-transparent p-10 rounded-lg text-center">
        <h1 className="text-4xl font-bold text-green-800 mb-4">
          Paddy Field is under maintenance
        </h1>
        ...
        <div className="mt-6">
          <svg
            className="w-16 h-16 text-green-800 animate-spin"
